...
class SmartSessionManager:
    ...
    def load_token_map(self):
        ...
        if need_download:
            print("⬇️ Downloading & Filtering Symbol Tokens (Auto-Expiry Mode)...")
            ...
            try:
                ...
                for item in data:
                    ...
                    # 4. MCX Auto-Expiry Logic (Commodities)
                    if exch == 'MCX' and name in symbols.COMMODITIES and 'FUT' in sym:
                        try:
                            # Angel uses format like "19OCT2023"
    ...
    # ✅ DYNAMIC EXCHANGE ROUTING LOGIC
    def get_exchange_and_symbol(self, symbol):
        ...
        if symbol == "SENSEX":
            exch = "BSE"
        elif any(comm in symbol for comm in symbols.COMMODITIES):
            exch = "MCX"
